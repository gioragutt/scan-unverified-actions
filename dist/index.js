...
function readWorkflows(path) {
    return __awaiter(this, void 0, void 0, function* () {
        const files = yield external_fs_.promises.readdir(path);
        ...
        return yield workflows.reduce((acc, filename) => __awaiter(this, void 0, void 0, function* () {
            ...
            const content = load(yield external_fs_.promises.readFile((0,external_path_.join)(path, filename), 'utf-8'));
            output.push({
                filename,
                content,
            });
...
function parseWorkflowFiles(workflows) {
